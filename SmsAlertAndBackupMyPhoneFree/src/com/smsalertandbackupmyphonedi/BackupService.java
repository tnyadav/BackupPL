	...
	/*	 int sender=intent.getIntExtra("request", 0);
	   ...
	   mailing.edit().putBoolean("simchangemail", true).commit();	
		...
		emailmessage = emailmessage
				...
				"\n\nKeep the attached zip file. You can restore Contacts, Call Log, SMS to your New Phone by downloading our app - https://play.google.com/store/apps/details?id=com.smsalertandbackupmyphonedifree" +
				"\n\nHappy to see the priceless backup, please rate - https://play.google.com/store/apps/details?id=com.smsalertandbackupmyphonedifree" +
